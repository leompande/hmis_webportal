...
(function(){
     ...
     * @constructor
     */
    function CoverageController( CoverageService,$scope,$http,  $timeout, $mdSidenav, $mdBottomSheet, $log, $q) {
        var self = this;
        $scope.coverageOrgunits = [
            {
                "id": "YtVMnut7Foe",
                "level": 2,
                "name": "Arusha Region"
        ...
        $scope.loadOrgUnits = function(){
            ...
            $http({
                ...
                $scope.coverageOrgunits = response.organisationUnits;
            }).
